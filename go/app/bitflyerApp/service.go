...
func StartBfService() {
	...
	if !config.Config.IsTest {
		scheduler.Every().Day().At("19:00").Run(wrapJob(buyingBTCJobEveryDay))
		scheduler.Every().Day().At("19:00").Run(wrapJob(buyingETHJobEveryDay))
		...
		scheduler.Every().Day().At("19:00").Run(wrapJob(buyingBTCJobLTP5t5Sun))
		scheduler.Every().Day().At("19:00").Run(wrapJob(buyingETHJobLTP5t5Sun))
		...
		scheduler.Every().Day().At("19:00").Run(wrapJob(savePriceHistoryJobFunc))
